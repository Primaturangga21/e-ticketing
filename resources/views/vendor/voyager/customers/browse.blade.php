...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        <a href="{{action('ProductController@downloadPDF', array($dataType->slug, $dataType->model_name))}}" class="btn btn-primary btn-add-new">
            <i class="voyager-receipt"></i> <span>Create Report</span>
        </a>
